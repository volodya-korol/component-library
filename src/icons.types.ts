declare module iconsT {
    ...
    export interface CheckBoxActive {
      fillRule: 'nonzero' | 'evenodd' | 'inherit';
      clipRule: string;
      d: string;
    }
    ...
    export interface HeartNo {
      fillRule: 'nonzero' | 'evenodd' | 'inherit';
      clipRule: string;
      d: string;
    }
  
    export interface HeartOutline {
      fillRule: 'nonzero' | 'evenodd' | 'inherit';
      clipRule: string;
      d: string;
    }
    ...
    export interface RadioButtonActive {
      fillRule: 'nonzero' | 'evenodd' | 'inherit';
      clipRule: string;
      d: string;
    }
    ...
    export interface VolumX {
      fillRule: 'nonzero' | 'evenodd' | 'inherit';
      clipRule: string;
      d: string;
    }
  
    export interface VolumeEmpty {
      fillRule: 'nonzero' | 'evenodd' | 'inherit';
      clipRule: string;
      d: string;
    }
